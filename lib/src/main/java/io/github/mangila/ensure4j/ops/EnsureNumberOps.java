...
public enum EnsureNumberOps {
  ...
  /**
   * Returns the given value if it is less than or equal to the specified boundary. If the value
   * exceeds the boundary, the provided RuntimeException is thrown.
   *
   * @param boundary the maximum allowed value
   * @param value the value to be checked against the boundary
   * @param runtimeExceptionSupplier the supplier of the RuntimeException to be thrown if the value
   ...
   */
  public long max(long boundary, long value, Supplier<RuntimeException> runtimeExceptionSupplier)
  ...
  /**
   * Ensures that the given value does not exceed the specified boundary. If the value exceeds the
   * boundary, an exception with the provided message is thrown.
   *
  ...
  /**
   * Returns the maximum of the boundary and value. If the value exceeds the boundary, an
   * EnsureException is thrown.
   *
   ...
   * @throws EnsureException with the message "value must be less than or equal to %d, but was %d" -
   *     if the given value exceeds the maximum allowable value
   */
  ...
  /**
   * Compares the provided number with a specified maximum value and throws a runtime exception if
   * the number exceeds the maximum.
   *
   * @param boundary the maximum allowable value
   * @param value the number to compare against the maximum
   * @param runtimeExceptionSupplier a runtimeExceptionSupplier for creating the runtime exception
   *     to be thrown if the provided number exceeds the maximum
   ...
   */
  public int max(int boundary, int value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value > boundary) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
  ...
  /**
   * Determines the maximum value between the specified integer values, and throws an {@code
   * EnsureException} with the provided message if the conditions are not met.
   *
  ...
  /**
   * Compares two integers and ensures the second integer is less than or equal to the first
   * integer.
   *
   * @param boundary the maximum allowable value
  ...
  /**
   * Ensures that the provided value is greater than or equal to the specified boundary. If the
   * value is less than the boundary, the provided exception supplier is used to generate and throw
   * a RuntimeException.
   *
   * @param boundary the minimum allowable value
   * @param value the value to be checked
   * @param runtimeExceptionSupplier a supplier that provides the RuntimeException to be thrown if
   *     the value is invalid
   * @return the provided value if it meets or exceeds the boundary
   * @throws RuntimeException if the value is less than the boundary, based on the supplied
   *     exception
   */
  public long min(long boundary, long value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value < boundary) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
  ...
  /**
   * Ensures that a given value meets or exceeds a specified boundary. If the value is less than the
   * boundary, an exception with the specified message is thrown.
   *
  ...
  /**
   * Determines the minimum value constrained by a specified boundary. If the given value is smaller
   * than the boundary, an exception will be thrown.
   *
   ...
   * @throws EnsureException with the message "value must be greater than or equal to %d, but was
   *     %d" - if the value is less than the specified minimum
   */
  ...
  /**
   * Compares a value against a minimum threshold and throws a supplied exception if the value is
   * less than the threshold.
   *
   * @param boundary the minimum threshold value
   * @param value the value to compare against the minimum
   * @param runtimeExceptionSupplier the runtimeExceptionSupplier that provides the runtime
   *     exception to be thrown if the comparison fails
   * @return the value of value if it is greater than or equal to the minimum threshold
   * @throws RuntimeException the exception supplied by the runtimeExceptionSupplier, thrown when
   *     the value is less than the minimum threshold
   */
  public int min(int boundary, int value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value < boundary) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
  ...
  /**
   * Compares the given integers and ensures that the second integer is not less than the minimum
   * value, throwing an exception with a specified message if the condition is violated.
   *
  ...
  /**
   * Compares two integers and ensures that the given value is greater than or equal to the defined
   * minimum.
   *
   ...
   */
  public long positive(long value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value <= 0) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
   ...
   *
   * @param value the value to check
   * @param exceptionMessage the message to include in the EnsureException if the value is not
   *     positive
   * @return the input value if it is positive
   ...
   * @param value the value to check
   * @return the input value if it is positive
   * @throws EnsureException with the message "value must be positive - (%s)" - if the value is not
   *     positive
   */
   ...
   * @throws RuntimeException if the value is not positive
   */
  public int positive(int value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value <= 0) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
   ...
   * @param value the value to check
   * @return the input value if it is positive
   * @throws EnsureException with the message "value must be positive" - if the value is not
   *     positive
   */
   ...
   * @param runtimeExceptionSupplier a supplier that provides the exception to be thrown if the
   *     value is negative
   * @return the input value if it is non-negative
   * @throws RuntimeException if the value is negative
   */
  public long positiveWithZero(long value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value < 0) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
   ...
   *
   * @param value the value to check
   * @param exceptionMessage the message to include in the EnsureException if the value is negative
   * @return the input value if it is non-negative
   * @throws EnsureException if the value is negative
   */
   ...
   * @param value the value to check
   * @return the input value if it is non-negative
   * @throws EnsureException with the message "value must be positive or zero - (%s)" - if the value
   *     is negative
   */
   ...
   * @throws RuntimeException if the value is negative
   */
  public int positiveWithZero(int value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value < 0) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
   ...
   */
  public long negative(long value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value >= 0) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
   ...
   * @param value the value to check
   * @return the input value if it is negative
   * @throws EnsureException with the message "value must be negative" - if the value is not
   *     negative
   */
   ...
   * @throws RuntimeException if the value is not negative
   */
  public int negative(int value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value >= 0) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
   ...
   */
  public long negativeWithZero(long value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value > 0) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
   ...
   * @param value the value to check
   * @return the input value if it is negative or zero
   * @throws EnsureException with the message "value must be negative or zero" - if the value is
   *     positive
   */
   ...
   * @throws RuntimeException if the value is positive
   */
  public int negativeWithZero(int value, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
    if (value > 0) {
      throw getSupplierOrThrow(runtimeExceptionSupplier);
    }
