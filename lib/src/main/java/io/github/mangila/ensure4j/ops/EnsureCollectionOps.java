...
public enum EnsureCollectionOps {
  ...
  /**
   * Checks if the specified collection contains the given element. If the element is not found, the
   * provided runtime exception supplier is used to throw an exception.
   *
  ...
  public <T extends Collection<?>> T containsElement(
      T collection, Object element, Supplier<RuntimeException> runtimeExceptionSupplier)
   ...
   * within the collection, a RuntimeException is thrown with the provided exception message.
   *
   * @param <T> the type of the collection
   ...
   * @param exceptionMessage the message to be included in the RuntimeException if the element is
   *     not found
   * @return the collection passed as input
  ...
  /**
   * Checks if the specified collection contains the given element. If the element is not found in
   * the collection, a RuntimeException is thrown.
   *
   * @param <T> the type of the collection
   ...
   * @return the collection passed as input
   * @throws RuntimeException with the message "collection must contain element %s" - if the element
   *     is not found in the collection
   */
  public <T extends Collection<?>> T containsElement(T collection, Object element)
      throws RuntimeException {
    return containsElement(
        collection, element, String.format("collection must contain element '%s'", element));
  }

  /**
   * Ensures that the provided collection does not contain any null elements. If the collection
   * contains a null element, an exception is thrown using the provided runtimeExceptionSupplier.
   * <br>
   * NOTE: This method will perform a null check on each element of the collection. Using a foreach
   * loop NOTE: There is no check if the collection is empty.
   *
   * @param <T> the type of the collection
   * @param collection the collection to be checked for null elements
   * @param runtimeExceptionSupplier the runtimeExceptionSupplier of the exception to be thrown if a
   *     null element is found
   * @return the collection passed as input
   * @throws EnsureException if the collection contains a null element
   */
  public <T extends Collection<?>> T notContainsNullIterate(
      T collection, Supplier<RuntimeException> runtimeExceptionSupplier) throws EnsureException {
  ...
  /**
   * Ensures that the provided collection does not contain any null elements. <br>
   * NOTE: This method will perform a null check on each element of the collection. Using a foreach
   * loop NOTE: There is no check if the collection is empty.
   *
   * @param <T> the type of the collection
   ...
   * @param collection the collection to be checked for null elements
   * @return the collection passed as input
   * @throws EnsureException with the message "collection must not contain null elements" - if the
   ...
   * contains a null element, an exception is thrown using the provided runtimeExceptionSupplier.
   * <br>
   * NOTE: This method will perform a null check using the built-in {@link
   * Collection#contains(Object)} method. NOTE: There is no check if the collection is empty.
   *
   * @param <T> the type of the collection
   * @param collection the collection to be checked for null elements
   * @param runtimeExceptionSupplier the runtimeExceptionSupplier of the exception to be thrown if a
  ...
  public <T extends Collection<?>> T notContainsNull(
      T collection, Supplier<RuntimeException> runtimeExceptionSupplier) throws RuntimeException {
  ...
  /**
   * Validates that the provided collection is not null and not empty. If the collection is null or
   * empty, a RuntimeException is thrown, which is either created using the provided
   * runtimeExceptionSupplier or thrown directly if the runtimeExceptionSupplier is null.
   *
   * @param <T> the type of the collection
   * @param collection the collection to be validated
   * @param runtimeExceptionSupplier the runtimeExceptionSupplier providing the RuntimeException to
   *     be thrown if the collection is null or empty
   * @return the collection passed as input
  ...
  /**
   * Validates that the provided collection is not null and not empty. If the collection is null or
   * empty, an EnsureException is thrown, which is either created using the provided supplier or
   * thrown directly if the supplier is null.
   *
   * @param <T> the type of the collection
   ...
   * @return the collection passed as input
   * @throws EnsureException with the message "collection must not be empty or null" - if the
   *     collection is empty
   */
