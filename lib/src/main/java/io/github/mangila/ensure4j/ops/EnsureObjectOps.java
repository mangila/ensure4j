...
public enum EnsureObjectOps {
  ...
  /**
   * Checks if the given object is an instance of the specified class. If the object is not an
   * instance of the class, a RuntimeException provided by the supplier is thrown.
   *
   * @param <T> the type of the object
   * @param clazz the class to check the object against
   * @param object the object to verify
   * @param supplier a supplier that provides the exception to be thrown if the object is not an
  ...
  public <T> T isInstanceOf(Class<T> clazz, Object object, Supplier<RuntimeException> supplier)
  ...
  /**
   * Ensures that the specified object is an instance of the given class. If the check fails, throws
   * an EnsureException with the provided exception message.
   *
   * @param <T> the type of the object
   ...
   * @return the non-null object passed as input
   * @throws EnsureException with the message "object must be an instance of %s" - if the object is
   ...
   * @param runtimeExceptionSupplier a supplier that provides a RuntimeException to be thrown if the
   *     enum values are not equal
  ...
  public <T extends Enum<T>> T isEquals(
      T enum1, T enum2, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws EnsureException {
    if (enum1 != enum2) {
   ...
   * @param enum1 The first Enum value to compare.
   * @param enum2 The second Enum value to compare.
   * @param exceptionMessage The message to include in the EnsureException if the values are not
   *     equal.
   * @return the first enum value if equal
   ...
   * @param enum2 the second Enum value to compare
   * @return the first enum value if equal
   * @throws EnsureException with the message "enums must be equal" - if the two Enum values are not
   *     equal
   */
  ...
  /**
   * Compares two objects for equality and throws a provided exception if they are not equal. If
   * both objects are the same instance or the first object equals the second, the method returns
   * without exception. If the first object is null or the objects are not equal, a custom exception
   * is thrown.
   *
   * @param <T> the type of the object
   ...
   */
  public <T> T isEquals(
      T object, Object otherObject, Supplier<RuntimeException> runtimeExceptionSupplier)
      throws RuntimeException {
  ...
  /**
   * Compares two objects for equality and throws an EnsureException with the specified message if
   * they are not equal.
   *
   * @param <T> the type of the object
   * @param object the first object to compare
   * @param otherObject the second object to compare
   * @param exceptionMessage the message to include in the EnsureException if the objects are not
   *     equal
   * @return the first object if equal
