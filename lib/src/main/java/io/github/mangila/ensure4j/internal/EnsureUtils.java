...
public final class EnsureUtils {
  ...
  /**
   * Checks if the provided string is blank. A string is considered blank if it is empty or contains
   ...
   * @param supplier the {@link Supplier} to provide the value; must not be null and must not return
   *     null
