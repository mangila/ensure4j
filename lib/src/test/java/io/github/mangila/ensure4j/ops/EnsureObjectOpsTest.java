...
public class EnsureObjectOpsTest {
    ...
    void isInstanceOfInstanceIsNullCustomException() {
        assertThatThrownBy(() -> ops.isInstanceOf(null, 123, () -> new IllegalArgumentException("custom exception")))
    ...
    void isInstanceOfCustomException() {
        assertThatThrownBy(() -> ops.isInstanceOf(String.class, 123, () -> new IllegalArgumentException("custom exception")))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("custom exception");
    }
    ...
    void isEqualsObjectNullFailure() {
        assertThatThrownBy(() -> ops.isEquals(null, "b"))
                .isInstanceOf(EnsureException.class);
    }
