...
class EnsureArchitectureTest implements ClazzTest, PublicMethodArchitectureTest {
      ...
      switch (methodName) {
        case "arrays" -> {
          ...
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, arraysCount, count);
        }
        case "collections" -> {
          int collectionsCount = 1;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, collectionsCount, count);
        }
        case "isFalse" -> {
          int isFalseCount = 3;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, isFalseCount, count);
        }
        case "isTrue" -> {
          int isTrueCount = 3;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, isTrueCount, count);
        }
        case "maps" -> {
          int mapsCount = 1;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, mapsCount, count);
        }
        case "numbers" -> {
          int numbersCount = 1;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, numbersCount, count);
        }
        case "objects" -> {
          int objectsCount = 1;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, objectsCount, count);
        }
        case "notNull" -> {
          int notNullCount = 3;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, notNullCount, count);
        }
        case "notNullOrElse" -> {
          int notNullOrElseCount = 1;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, notNullOrElseCount, count);
        }
        case "notNullOrElseGet" -> {
          int notNullOrElseGetCount = 1;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, notNullOrElseGetCount, count);
        }
        // TODO: remove
        case "notNullOrElseThrow" -> {
          ...
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, notNullOrElseThrowCount, count);
        }
        case "strings" -> {
          int stringsCount = 1;
          var count = countByName.get(methodName);
          ArchTestUtils.checkOrAddMethodNameViolationEvent(
              javaClass, events, methodName, stringsCount, count);
        }
